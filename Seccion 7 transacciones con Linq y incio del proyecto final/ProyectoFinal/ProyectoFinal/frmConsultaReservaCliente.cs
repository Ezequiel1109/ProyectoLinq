...
{
    public partial class frmConsultaReservaCliente : Form
    {
        public frmConsultaReservaCliente()
        {
            InitializeComponent();
        }
        ConexiondbmlDataContext bd = new ConexiondbmlDataContext();
        private void frmConsultaReservaCliente_Load(object sender, EventArgs e)
        {
