...
// Code is generated on: 30-01-2021 11:55:33
//
...
namespace NorthwindContext
{
    ...
    public partial class Employee : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Employee_Territory", Storage="_Territories", ThisKey="EmployeeID", OtherKey="TerritoryID", LinkTableName=@"dbo.EmployeeTerritories", LinkThisKey=@"EmployeeID", LinkOtherKey=@"TerritoryID")]
        ...
        private void attach_Territories(Territory entity)
        {
            ...
            entity.Employees.Add(this);
        }
    
        private void detach_Territories(Territory entity)
        {
            this.SendPropertyChanging("Territories");
            entity.Employees.Remove(this);
        }
    }
    ...
    public partial class Territory : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Employee_Territory", Storage="_Employees", ThisKey="TerritoryID", OtherKey="EmployeeID", LinkTableName=@"dbo.EmployeeTerritories", LinkThisKey=@"TerritoryID", LinkOtherKey=@"EmployeeID")]
        ...
        private void attach_Employees(Employee entity)
        {
            ...
            entity.Territories.Add(this);
        }
    
        private void detach_Employees(Employee entity)
        {
            this.SendPropertyChanging("Employees");
            entity.Territories.Remove(this);
        }
    }
